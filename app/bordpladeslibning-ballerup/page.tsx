...
const faqItems = [
  {
    question: "Kører I i hele Ballerup?",
    answer:
      "Ja, vi dækker hele Ballerup og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Ballerup",
  description:
    "Bordpladeslibning i massiv træ i Ballerup med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-ballerup"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Ballerup",
    item: "https://bpslib.dk/bordpladeslibning-ballerup"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Ballerup (massiv træ)",
  description:
    "Bordpladeslibning i Ballerup – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-ballerup"
});

export default function BordpladeBallerupPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Ballerup – kun massiv træ"
        intro="Vi hjælper i Ballerup med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Ballerup</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Ballerup møder vi ofte villaer og rækkehuse med store køkkenbordplader, hvor adgang og
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Ballerup</h2>
        <div className="mt-4 rounded-2xl border border-border/70 bg-white/70 p-5 text-sm text-muted-foreground">
          <ul className="grid gap-2">
            <li>
              ...
              felter og skjolder efter daglig brug.
            </li>
            <li>
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Ballerup, Skovlunde, Måløv, Smørum, Herlev (nært), Egedal (nært).
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Ballerup." />
