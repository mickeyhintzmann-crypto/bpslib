...
const faqItems = [
  {
    question: "Kører I i hele Ringsted?",
    answer:
      "Ja, vi dækker hele Ringsted og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Ringsted",
  description:
    "Bordpladeslibning i massiv træ i Ringsted med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-ringsted"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Ringsted",
    item: "https://bpslib.dk/bordpladeslibning-ringsted"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Ringsted (massiv træ)",
  description:
    "Bordpladeslibning i Ringsted – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-ringsted"
});

export default function BordpladeRingstedPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Ringsted – kun massiv træ"
        intro="Vi hjælper i Ringsted med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Ringsted</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Ringsted møder vi ofte huse og rækkehuse med køkkenbordplader, der er slidte efter
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Ringsted</h2>
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Ringsted, Benløse, Haraldsted, Jystrup, Sorø (nært), Borup (nært), Haslev (nært).
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Ringsted." />
