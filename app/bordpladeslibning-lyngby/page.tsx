...
const faqItems = [
  {
    question: "Kører I i hele Lyngby-området?",
    answer:
      "Ja, vi dækker Lyngby og nærområder og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Lyngby",
  description:
    "Bordpladeslibning i massiv træ i Lyngby med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-lyngby"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Lyngby",
    item: "https://bpslib.dk/bordpladeslibning-lyngby"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Lyngby (massiv træ)",
  description:
    "Bordpladeslibning i Lyngby – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-lyngby"
});

export default function BordpladeLyngbyPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Lyngby – kun massiv træ"
        intro="Vi hjælper i Lyngby med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Lyngby</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Lyngby arbejder vi både i lejligheder og villaer med større køkkenbordplader, hvor adgang
          og parkering skal planlægges. Vi tilpasser tidspunktet, så arbejdet bliver roligt og
          effektivt, og vi beskytter gulve og områder omkring bordpladen. Hvis du er i tvivl om
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Lyngby</h2>
        <div className="mt-4 rounded-2xl border border-border/70 bg-white/70 p-5 text-sm text-muted-foreground">
          <ul className="grid gap-2">
            <li>
              <span className="font-semibold text-foreground">Problem:</span> Stor bordplade med
              skjolder og matte felter efter daglig brug.
            </li>
            <li>
              <span className="font-semibold text-foreground">Løsning:</span> Skånsom slibning og ny
              oliebehandling med fokus på ensartet finish.
            </li>
            <li>
              <span className="font-semibold text-foreground">Resultat:</span> Klar overflade og
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Kongens Lyngby, Virum, Sorgenfri, Lundtofte, Hjortekær, Brede, Ulrikkenborg, Bagsværd
          (nært).
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Lyngby." />
