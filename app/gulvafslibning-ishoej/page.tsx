...
const faqItems = [
  {
    question: "Hvad koster gulvafslibning i Ishøj?",
    answer:
...
export const metadata = buildMetadata({
  title: "Gulvafslibning i Ishøj | Uforpligtende tilbud | BPSLIB",
  description: "Gulvafslibning i Ishøj. Book uforpligtende tilbudstid eller kontakt os.",
  path: "/gulvafslibning-ishoej"
});

export default function GulvIshoejPage() {
  return (
      ...
      <section className="mt-8 overflow-hidden rounded-[30px] border border-border/70 bg-[linear-gradient(145deg,hsl(34_60%_98%),hsl(0_0%_100%))] p-6 shadow-[0_20px_44px_hsl(24_24%_18%/0.08)] md:p-8">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          <article className="rounded-2xl border border-border/70 bg-white/90 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-foreground">Slidt gulv med ridser og matte felter i bolig.</p>
          </article>
          <article className="rounded-2xl border border-border/70 bg-white/90 p-4">
