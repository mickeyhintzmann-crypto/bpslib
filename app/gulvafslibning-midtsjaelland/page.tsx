...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Ja, vi dækker hele Midtsjælland og planlægger ruter, så tiderne er stabile."
  }
];

export const metadata = buildMetadata({
  title: "Gulvafslibning i Midtsjælland | Uforpligtende tilbud | BPSLIB",
  description:
    "Gulvafslibning i Midtsjælland. Book uforpligtende tilbudstid eller kontakt os. Vi kører på hele Sjælland.",
  path: "/gulvafslibning-midtsjaelland"
});

export default function GulvMidtsjaellandPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        <h1 className="font-display text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
          Gulvafslibning i Midtsjælland
        </h1>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Midtsjælland som lead-gen i MVP. Du får et uforpligtende
