...
const faqItems = [
  {
    question: "Hvad koster gulvafslibning i Køge?",
    answer:
...
export const metadata = buildMetadata({
  title: "Gulvafslibning i Køge | Uforpligtende tilbud | BPSLIB",
  description: "Gulvafslibning i Køge. Book uforpligtende tilbudstid eller kontakt os.",
  path: "/gulvafslibning-koege"
});

export default function GulvKoegePage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Køge som lead-gen i MVP. Området har både ældre huse og nyere
