...
const faqItems = [
  {
    question: "Kører I i hele Amager?",
    answer:
      "Ja, vi dækker hele Amager og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning på Amager",
  description:
    "Bordpladeslibning i massiv træ på Amager med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-amager"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning på Amager",
    item: "https://bpslib.dk/bordpladeslibning-amager"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning på Amager (massiv træ)",
  description:
    "Bordpladeslibning på Amager – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-amager"
});

export default function BordpladeAmagerPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Amager, Amagerbro, Islands Brygge, Sundby, Ørestad, Tårnby, Kastrup, Dragør,
          Christianshavn, København S.
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning på Amager." />
