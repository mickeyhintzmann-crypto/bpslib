...
const faqItems = [
  ...
  {
    question: "Kører I i hele Vest- & Sydsjælland?",
    answer:
      "Ja, vi dækker hele området og planlægger ruter, så tiderne er stabile."
  }
];

export const metadata = buildMetadata({
  title: "Gulvafslibning i Vest- & Sydsjælland | Uforpligtende tilbud | BPSLIB",
  description:
    "Gulvafslibning i Vest- og Sydsjælland. Book uforpligtende tilbudstid eller kontakt os. Vi kører på hele Sjælland.",
  path: "/gulvafslibning-vest-sydsjaelland"
});
    ...
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Vest- og Sydsjælland som lead-gen i MVP. Du får et
