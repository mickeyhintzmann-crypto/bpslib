...
const faqItems = [
  ...
  {
    question: "Kører I på hele Amager?",
    answer:
      "Ja, vi dækker Amager og planlægger ruter, så tiderne er stabile."
  }
];

export const metadata = buildMetadata({
  title: "Gulvafslibning på Amager | Uforpligtende tilbud | BPSLIB",
  description:
    "Gulvafslibning på Amager. Book uforpligtende tilbudstid eller kontakt os. Vi kører på hele Sjælland.",
  path: "/gulvafslibning-amager"
});

export default function GulvAmagerPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning på Amager. Du får et uforpligtende tilbud baseret på gulvtype, areal og ønsket behandling. Vi kører på hele{" "}
          <Link href="/gulvafslibning-sjaelland" className="font-medium text-foreground hover:text-primary">
            Sjælland
          </Link>
          , og planlægger tider så det er nemt at komme videre.
        </p>
      ...
      <section className="mt-8 rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Amager, Amagerbro, Islands Brygge, Sundby, Ørestad, Tårnby, Kastrup, Dragør, Christianshavn,
          København S.
        </p>
      </section>
