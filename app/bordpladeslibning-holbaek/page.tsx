...
const faqItems = [
  {
    question: "Kører I i hele Holbæk?",
    answer:
      "Ja, vi dækker hele Holbæk og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Holbæk",
  description:
    "Bordpladeslibning i massiv træ i Holbæk med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-holbaek"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Holbæk",
    item: "https://bpslib.dk/bordpladeslibning-holbaek"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Holbæk (massiv træ)",
  description:
    "Bordpladeslibning i Holbæk – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-holbaek"
});

export default function BordpladeHolbaekPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Holbæk – kun massiv træ"
        intro="Vi hjælper i Holbæk med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Holbæk</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Holbæk møder vi ofte huse og rækkehuse med køkkenbordplader, der er slidte efter daglig
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Holbæk</h2>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Holbæk." />
