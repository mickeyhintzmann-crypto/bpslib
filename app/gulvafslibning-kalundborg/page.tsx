...
const faqItems = [
  {
    question: "Hvad koster gulvafslibning i Kalundborg?",
    answer:
...
export const metadata = buildMetadata({
  title: "Gulvafslibning i Kalundborg | Uforpligtende tilbud | BPSLIB",
  description: "Gulvafslibning i Kalundborg. Book uforpligtende tilbudstid eller kontakt os.",
  path: "/gulvafslibning-kalundborg"
});

export default function GulvKalundborgPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        <h1 className="font-display text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
          Gulvafslibning i Kalundborg
        </h1>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Kalundborg. Du får et uforpligtende tilbud baseret på gulvtype, areal og ønsket behandling. Området har både helårshuse og
          sommerhuse, og vi tilpasser forløbet efter gulvtype og adgangsforhold. Du får et uforpligtende
