    ...
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i København som lead-gen i MVP. I lejligheder og etageejendomme
      ...
      <section className="mt-8 rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
          <li>
            <span className="font-semibold text-foreground">Problem:</span> Slidt plankegulv i københavnerlejlighed med ridser og matte felter.
          </li>
          <li>
            <span className="font-semibold text-foreground">Løsning:</span> Kontrolleret slibning med støvkontrol og ny finish.
          </li>
          <li>
            <span className="font-semibold text-foreground">Resultat:</span> Ensartet overflade med roligt udtryk og bedre hverdagsstyrke.
          </li>
        </ul>
      </section>
