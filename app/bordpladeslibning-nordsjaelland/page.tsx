...
const faqItems = [
  {
    question: "Kører I i hele Nordsjælland?",
    answer:
      "Ja, vi dækker hele Nordsjælland og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Nordsjælland",
  description:
    "Bordpladeslibning i massiv træ i Nordsjælland med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-nordsjaelland"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Nordsjælland",
    item: "https://bpslib.dk/bordpladeslibning-nordsjaelland"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Nordsjælland (massiv træ)",
  description:
    "Bordpladeslibning i Nordsjælland – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-nordsjaelland"
});

export default function BordpladeNordsjaellandPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="Region-hub"
        title="Bordpladeslibning i Nordsjælland – kun massiv træ"
        intro="Vi hjælper i Nordsjælland med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Hillerød, Helsingør, Fredensborg, Humlebæk, Nivå, Kokkedal, Hørsholm, Rungsted, Vedbæk,
          Virum, Lyngby, Gentofte, Birkerød, Allerød.
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Nordsjælland." />
