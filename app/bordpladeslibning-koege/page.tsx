...
const faqItems = [
  {
    question: "Kører I i hele Køge?",
    answer:
      "Ja, vi dækker hele Køge og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Køge",
  description:
    "Bordpladeslibning i massiv træ i Køge med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-koege"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Køge",
    item: "https://bpslib.dk/bordpladeslibning-koege"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Køge (massiv træ)",
  description:
    "Bordpladeslibning i Køge – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-koege"
});

export default function BordpladeKoegePage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Køge – kun massiv træ"
        intro="Vi hjælper i Køge med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Køge</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Køge møder vi ofte huse og rækkehuse med køkkenbordplader, der er slidte efter daglig
          brug. Adgang og parkering kan variere fra kvarter til kvarter, så vi planlægger tidspunktet,
          så arbejdet bliver roligt og effektivt. Vi beskytter gulve og flader omkring bordpladen,
          og hvis du er i tvivl om materialet, starter vi med{" "}
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Køge</h2>
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Køge, Ølby, Herfølge, Ejby, Bjæverskov, Borup (nært), Solrød (nært), Karlslunde (nært).
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Køge." />
