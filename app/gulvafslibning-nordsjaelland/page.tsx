...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Ja, vi dækker hele Nordsjælland og planlægger ruter, så tiderne er stabile."
  }
];

export const metadata = buildMetadata({
  title: "Gulvafslibning i Nordsjælland | Uforpligtende tilbud | BPSLIB",
  description:
    "Gulvafslibning i Nordsjælland. Book uforpligtende tilbudstid eller kontakt os. Vi kører på hele Sjælland.",
  path: "/gulvafslibning-nordsjaelland"
});

export default function GulvNordsjaellandPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        <h1 className="font-display text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
          Gulvafslibning i Nordsjælland
        </h1>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Nordsjælland som lead-gen i MVP. Du får et uforpligtende
          tilbud baseret på gulvtype, areal og ønsket behandling. Vi kører på hele{" "}
          <Link href="/gulvafslibning-sjaelland" className="font-medium text-foreground hover:text-primary">
            Sjælland
          </Link>
          , og tilrettelægger forløbet, så du hurtigt kan komme videre.
        </p>
