...
const faqItems = [
  {
    question: "Kører I i hele Hvidovre?",
    answer:
      "Ja, vi dækker hele Hvidovre og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Hvidovre",
  description:
    "Bordpladeslibning i massiv træ i Hvidovre med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-hvidovre"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Hvidovre",
    item: "https://bpslib.dk/bordpladeslibning-hvidovre"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Hvidovre (massiv træ)",
  description:
    "Bordpladeslibning i Hvidovre – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-hvidovre"
});

export default function BordpladeHvidovrePage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Hvidovre – kun massiv træ"
        intro="Vi hjælper i Hvidovre med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Hvidovre</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Hvidovre møder vi ofte rækkehuse og villaer med solide køkkenbordplader, hvor adgang og
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Hvidovre</h2>
        <div className="mt-4 rounded-2xl border border-border/70 bg-white/70 p-5 text-sm text-muted-foreground">
          <ul className="grid gap-2">
            <li>
              ...
              slidte felter og mærker fra daglig brug.
            </li>
            <li>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Hvidovre." />
