...
const faqItems = [
  {
    question: "Kører I i hele Rødovre?",
    answer:
      "Ja, vi dækker hele Rødovre og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Rødovre",
  description:
    "Bordpladeslibning i massiv træ i Rødovre med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-roedovre"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Rødovre",
    item: "https://bpslib.dk/bordpladeslibning-roedovre"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Rødovre (massiv træ)",
  description:
    "Bordpladeslibning i Rødovre – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-roedovre"
});

export default function BordpladeRoedovrePage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Rødovre – kun massiv træ"
        intro="Vi hjælper i Rødovre med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Rødovre</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Rødovre møder vi ofte rækkehuse og villaer med robuste køkkenbordplader, hvor adgang og
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Rødovre</h2>
        <div className="mt-4 rounded-2xl border border-border/70 bg-white/70 p-5 text-sm text-muted-foreground">
          <ul className="grid gap-2">
            <li>
              ...
              dybe ridser og skjolder fra daglig brug.
            </li>
            <li>
              <span className="font-semibold text-foreground">Løsning:</span> Trinvis slibning og ny
              overfladebehandling med fokus på holdbarhed.
            </li>
            <li>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Rødovre." />
