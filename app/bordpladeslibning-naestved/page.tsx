...
const faqItems = [
  {
    question: "Kører I i hele Næstved?",
    answer:
      "Ja, vi dækker hele Næstved og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Næstved",
  description:
    "Bordpladeslibning i massiv træ i Næstved med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-naestved"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Næstved",
    item: "https://bpslib.dk/bordpladeslibning-naestved"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Næstved (massiv træ)",
  description:
    "Bordpladeslibning i Næstved – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-naestved"
});

export default function BordpladeNaestvedPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Næstved</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Næstved møder vi ofte huse og rækkehuse med køkkenbordplader, der er slidte efter
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Næstved</h2>
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Næstved, Holmegaard, Fensmark, Karrebæksminde, Fuglebjerg (nært), Haslev (nært),
          Vordingborg (nært).
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Næstved." />
