...
const faqItems = [
  {
    question: "Kører I i hele Frederiksberg?",
    answer:
      "Ja, vi dækker hele Frederiksberg og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning på Frederiksberg",
  description:
    "Bordpladeslibning i massiv træ på Frederiksberg med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-frederiksberg"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning på Frederiksberg",
    item: "https://bpslib.dk/bordpladeslibning-frederiksberg"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning på Frederiksberg (massiv træ)",
  description:
    "Bordpladeslibning på Frederiksberg – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-frederiksberg"
});
    ...
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          ...
          god planlægning. Vi tilpasser tidspunkter, så opgangen og køkkenet forstyrres mindst
          muligt, og vi beskytter gulve og nærliggende flader. Hvis du er i tvivl om materialet,
          starter vi med{" "}
        ...
        <div className="mt-4 rounded-2xl border border-border/70 bg-white/70 p-5 text-sm text-muted-foreground">
          <ul className="grid gap-2">
            <li>
              ...
              skjolder og varmepletter i et køkken på Frederiksberg.
            </li>
            <li>
              <span className="font-semibold text-foreground">Løsning:</span> Skånsom slibning og ny
              oliebehandling med fokus på ensartet glød.
            </li>
            <li>
              <span className="font-semibold text-foreground">Resultat:</span> Glat overflade og
              frisk finish, klar til daglig brug.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          ...
          Fasanvej, Flintholm, Grøndal, Peter Bangs Vej.
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning på Frederiksberg." />
