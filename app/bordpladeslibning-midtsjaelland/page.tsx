...
const faqItems = [
  {
    question: "Kører I i hele Midtsjælland?",
    answer:
      "Ja, vi dækker hele Midtsjælland og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Midtsjælland",
  description:
    "Bordpladeslibning i massiv træ i Midtsjælland med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-midtsjaelland"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Midtsjælland",
    item: "https://bpslib.dk/bordpladeslibning-midtsjaelland"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Midtsjælland (massiv træ)",
  description:
    "Bordpladeslibning i Midtsjælland – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-midtsjaelland"
});
...
export default function BordpladeMidtsjaellandPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="Region-hub"
        title="Bordpladeslibning i Midtsjælland – kun massiv træ"
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Roskilde, Lejre, Ringsted, Borup, Hvalsø, Jyllinge, Viby Sjælland, Køge, Solrød, Greve,
          Ishøj, Ballerup, Hedehusene, Taastrup.
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Midtsjælland." />
