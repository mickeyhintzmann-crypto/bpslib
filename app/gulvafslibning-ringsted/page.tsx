...
const faqItems = [
  {
    question: "Hvad koster gulvafslibning i Ringsted?",
    answer:
...
export const metadata = buildMetadata({
  title: "Gulvafslibning i Ringsted | Uforpligtende tilbud | BPSLIB",
  description: "Gulvafslibning i Ringsted. Book uforpligtende tilbudstid eller kontakt os.",
  path: "/gulvafslibning-ringsted"
});

export default function GulvRingstedPage() {
  return (
    <CityServicePage category="gulv">
      <CityImageHero backgroundImage="/media/featured%3Agulv/20230219_193820.jpg">
        <h1 className="font-display text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
          Gulvafslibning i Ringsted
        </h1>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Ringsted. Du får et uforpligtende tilbud baseret på gulvtype, areal og ønsket behandling. Området har både ældre huse og
