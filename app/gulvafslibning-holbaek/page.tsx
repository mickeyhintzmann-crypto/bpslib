...
const faqItems = [
  {
    question: "Hvad koster gulvafslibning i Holbæk?",
    answer:
...
export const metadata = buildMetadata({
  title: "Gulvafslibning i Holbæk | Uforpligtende tilbud | BPSLIB",
  description: "Gulvafslibning i Holbæk. Book uforpligtende tilbudstid eller kontakt os.",
    ...
    <main className="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
      <section className="rounded-3xl border border-border/70 bg-white/75 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Holbæk. Du får et uforpligtende tilbud baseret på gulvtype, areal og ønsket behandling. Området har både ældre huse og
