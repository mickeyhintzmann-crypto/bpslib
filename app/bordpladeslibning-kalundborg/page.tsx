...
const faqItems = [
  {
    question: "Kører I i hele Kalundborg?",
    answer:
      "Ja, vi dækker hele Kalundborg og planlægger ruter, så du får en stabil tid."
  },
  {
...
const serviceSchema = buildServiceSchema({
  name: "Bordpladeslibning i Kalundborg",
  description:
    "Bordpladeslibning i massiv træ i Kalundborg med fokus på finish, prisgennemsigtighed og hurtig responstid.",
  url: "https://bpslib.dk/bordpladeslibning-kalundborg"
});
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  {
    name: "Bordpladeslibning i Kalundborg",
    item: "https://bpslib.dk/bordpladeslibning-kalundborg"
  }
]);

export const metadata = buildMetadata({
  title: "Bordpladeslibning i Kalundborg (massiv træ)",
  description:
    "Bordpladeslibning i Kalundborg – kun massiv træ. Få pris via billeder, book tid eller se akutte tider.",
  path: "/bordpladeslibning-kalundborg"
});

export default function BordpladeKalundborgPage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 pb-16">
      <PageHero
        eyebrow="By-side"
        title="Bordpladeslibning i Kalundborg – kun massiv træ"
        intro="Vi hjælper i Kalundborg med slibning, genopfriskning og finish af massiv træbordplader. Du får et enkelt forløb, klare anbefalinger og gennemsigtig pris."
      />

      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        <h2 className="text-2xl font-semibold text-foreground">Lokal indsigt i Kalundborg</h2>
        <p className="mt-3 text-sm text-muted-foreground">
          I Kalundborg møder vi både huse og sommerhuse med køkkenbordplader, der er slidte efter
          daglig brug. Adgang og parkering kan variere fra område til område, så vi planlægger
      ...
      <section className="py-10 md:py-14">
        <h2 className="text-2xl font-semibold text-foreground">Mini-case fra Kalundborg</h2>
      ...
      <section className="rounded-3xl border border-border/70 bg-white/70 p-6 md:p-8">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Kalundborg, Høng, Gørlev, Ubby, Rørby, Jyderup (nært), Svebølle.
        </p>
      </section>
      ...
      <FaqSection items={faqItems} intro="Kort FAQ om bordpladeslibning i Kalundborg." />
