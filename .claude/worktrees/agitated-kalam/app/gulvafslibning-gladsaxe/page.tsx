...
const faqItems = [
  {
    question: "Hvad koster gulvafslibning i Gladsaxe?",
    answer:
...
export const metadata = buildMetadata({
  title: "Gulvafslibning i Gladsaxe | Uforpligtende tilbud | BPSLIB",
  description: "Gulvafslibning i Gladsaxe. Book uforpligtende tilbudstid eller kontakt os.",
  path: "/gulvafslibning-gladsaxe"
});

export default function GulvGladsaxePage() {
  return (
    <CityServicePage category="gulv">
      <CityImageHero backgroundImage="/media/featured%3Agulv/feature.2.jpeg">
        <h1 className="font-display text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
          Gulvafslibning i Gladsaxe
        </h1>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground md:text-base">
          Vi hjælper med gulvafslibning i Gladsaxe. Du får et uforpligtende tilbud baseret på gulvtype, areal og ønsket behandling. Området rummer både rækkehuse
          og villaer, og vi tilpasser forløbet efter adgang og praktiske forhold. Vi kører også i{" "}
      ...
      <section className="mt-8 overflow-hidden rounded-[30px] border border-border/70 bg-[linear-gradient(145deg,hsl(34_60%_98%),hsl(0_0%_100%))] p-6 shadow-[0_20px_44px_hsl(24_24%_18%/0.08)] md:p-8">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-3">
          <article className="rounded-2xl border border-border/70 bg-white/90 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-foreground">Slidt trægulv med ridser og pletter i bolig.</p>
          </article>
          <article className="rounded-2xl border border-border/70 bg-white/90 p-4">
          ...
          <article className="rounded-2xl border border-border/70 bg-white/90 p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-foreground">Jævnt gulv med rolig glans og bedre holdbarhed.</p>
          </article>
        </div>
      </section>
      ...
      <section className="mt-8 city-surface city-surface--panel rounded-[28px] p-6 md:p-8">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Søborg, Bagsværd, Mørkhøj, Buddinge, Stengård, Høje Gladsaxe, Værebro, Dyssegård (nært).
        </p>
      </section>
