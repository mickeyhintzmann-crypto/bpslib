...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Åbningstider", href: "/admin/kalender", roles: ["owner", "admin"] },
  { label: "Jobs", href: "/admin/jobs", roles: ["owner", "admin", "viewer"] },
  { label: "Driftsmedarbejdere", href: "/admin/employees", roles: ["owner", "admin"] },
  { label: "Kundehenvendelser", href: "/admin/leads", roles: ["owner", "admin", "viewer"] },
