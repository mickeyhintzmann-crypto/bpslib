      ...
      >
        {hasImageHero ? (
          <section className="relative min-h-[560px] w-full overflow-hidden">
            ...
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-[linear-gradient(94deg,hsl(228_30%_8%/0.90)_0%,hsl(228_30%_8%/0.74)_45%,hsl(228_30%_8%/0.42)_100%)]"
            />
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-[radial-gradient(120%_140%_at_10%_18%,hsl(228_38%_5%/0.26)_0%,transparent_56%)]"
            />
            ...
            <div className="relative mx-auto grid min-h-[560px] w-full max-w-[1320px] items-center gap-6 px-4 py-10 md:px-6 md:py-14 lg:grid-cols-[1.1fr_0.9fr]">
              <section className="max-w-3xl rounded-3xl border border-white/18 bg-black/30 p-5 shadow-[0_24px_46px_hsl(228_30%_7%/0.34)] backdrop-blur-[1px] md:p-7">
                <h1 className="font-display text-4xl font-semibold tracking-tight text-white md:text-6xl">
                  {title}
                </h1>
                {subtitle ? (
                  <p className="mt-4 max-w-3xl text-base leading-relaxed text-white/95 md:text-[1.15rem]">
                    {subtitle}
                  </p>
                ) : null}
                ...
                {bullets.length ? (
                  <ul className="mt-6 grid max-w-2xl gap-2.5">
                    {bullets.slice(0, 4).map((point) => (
                      <li
                        key={point}
                        className="flex items-start gap-3 rounded-xl border border-white/20 bg-black/25 px-3 py-2.5"
                      >
                        <span
                          aria-hidden="true"
                          className="mt-0.5 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-primary/45 bg-primary/22 text-primary-foreground"
                        >
                          <svg
                            viewBox="0 0 24 24"
                        ...
                        <span className="pt-0.5 text-[15px] leading-relaxed text-white/95">{point}</span>
                      </li>
                    ))}
                  </ul>
                ) : null}
              ...
              <aside className="grid gap-4">
                <section className="rounded-[26px] border border-white/70 bg-white/95 p-6 shadow-[0_26px_44px_hsl(228_28%_10%/0.30)] backdrop-blur-[1px] md:p-7">
                ...
                <section className="rounded-[26px] border border-white/70 bg-white/95 p-6 shadow-[0_26px_44px_hsl(228_28%_10%/0.24)] backdrop-blur-[1px] md:p-7">
