      ...
      <div className="relative mx-auto w-full max-w-[1320px] px-4 py-11 md:px-6 md:py-16">
        <div className="max-w-4xl rounded-[34px] bg-[linear-gradient(120deg,hsl(var(--primary)/0.62)_0%,hsl(34_98%_66%/0.42)_36%,hsl(203_88%_62%/0.32)_100%)] p-[1px] shadow-[0_36px_70px_hsl(228_30%_8%/0.42)]">
          <div
            className={
              panelTransparent
                ? "overflow-hidden rounded-[33px] border border-white/35 bg-white/72 backdrop-blur-[1px]"
                : "overflow-hidden rounded-[33px] border border-white/30 bg-[linear-gradient(165deg,hsl(0_0%_100%/0.98)_0%,hsl(37_60%_96%/0.95)_72%,hsl(35_58%_94%/0.92)_100%)]"
            }
          >
            <div
              aria-hidden="true"
